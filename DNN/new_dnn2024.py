...
# Load the dataset
file_path = '/Users/berkecaliskan/Documents/new_transmitter_localization/transmitter_localization/cnn_data_new/data_with_labels.npy'
...
# Flatten data from 2D (320, 142) to 1D (45440)
...
model = Sequential([
    ...
    Dense(6)  # Output layer with 6 units for the 6 coordinates
])
...
combined_csv_file_path = '/Users/berkecaliskan/Documents/new_transmitter_localization/transmitter_localization/DNN/ground_truths_and_predictions_new_cnn2024.csv'  # Update with the actual path
